...
func errorHandler(c *gin.Context, info ratelimit.Info) {
	...
	c.JSON(429, gin.H{
		"code":    configs2.Errors().E2.Code,
		"message": configs2.Errors().E2.Message + ", try again in " + time.Until(info.ResetTime).String(),
	})
}

func RateLimitMiddleware(boot configs2.BootHandlers) gin.HandlerFunc {
